...
<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="collapse_navbar">
				<ul class="nav navbar-nav">
					<li class="nav-item">
						<a class="nav-link active" aria-current="page" href="#">主畫面</a>
					</li>
					<li class="nav-item">
	...
	<!--opening開場動畫-->
	<div id="opening">
		<div id="opening_display_block">
			<img src="image/opening1.png" id="op1" class="img-responsive opening_img" style="z-index:2;">
			<img src="image/opening2.png" id="op2" class="img-responsive opening_img" style="z-index:3;">
			<img src="image/opening3.png" id="op3" class="img-responsive opening_img" style="z-index:1;">
			<img src="image/opening4.png" id="op4" class="img-responsive opening_img" style="z-index:4;">
			<img src="image/logo.png" id="op5" style="z-index:5;opacity:0;">
		</div>
	</div>
	...
	<div id="container">
		...
		<!--地圖-->
		<div id="map_cover">
			<div id="map_cover_text" style="width:100%;height:100%;">
				<div id="map_cover_text1">CLICK<br>TO<br>MOVE MAP</div>
				<div id="map_cover_text2"><b>帶我去一個 沒有告別的故鄉<br>走一趟 <span style="color:#b2881f;">沒有腳印的流浪<span></b></div>
			</div>
			<div id="map_cover_ins1" class="instruct"><span class="glyphicon glyphicon-arrow-left"></span>切換圖層/篩選器</div>
			<div id="map_cover_ins2" class="instruct">切換底圖<span class="glyphicon glyphicon-arrow-right"></span></div>
		</div>
		<div id="map">
		</div>
	</div>
