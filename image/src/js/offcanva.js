...
function openNav() {
	...
	document.getElementById("map_cover_text1").style.marginLeft = "35%";
	document.getElementById("map_cover_text2").style.marginLeft = "35%";
...
function closeNav() {
	...
	document.getElementById("map_cover_text1").style.marginLeft = "10%";
	document.getElementById("map_cover_text2").style.marginLeft = "10%";
